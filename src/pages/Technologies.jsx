...
const Technologies = () => {
  ...
  // Function to open modal with selected technology description
    ...
    <div className="technologies-container">
      {technologiesData.map((tech, index) => (
        <div key={index} className="technology-card">
          ...
          <h3>{tech.title}</h3>
          <p className="para-tech">{tech.description.substring(0, 100)}...</p>
          <button onClick={() => openModal(tech.description)}>View More</button>
        </div>
      ))}
